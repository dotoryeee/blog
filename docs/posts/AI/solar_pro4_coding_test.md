...
Claude Code는 Claude Max 20x 요금제를 쓰고 있어서 손에 익은 도구다. [업스테이지](https://www.upstage.ai/)가 Solar Pro 4를 내놨길래 코딩 실력이 궁금했다. 마침 이 모델을 [Nous Research](https://nousresearch.com/)의 Hermes Agent에서 쓸 수 있다고 해서 그 조합으로 시켜봤다. 비교 기준은 익숙한 Claude Code의 Sonnet 5와 Opus 5로 잡았고 내친김에 [z.ai](https://z.ai/)의 GLM-4.7 두 종(무료 Flash, 유료 일반)도 Hermes에 연동해 같은 과제를 줬다. 로그 분석에는 Opus 5와 Fable 5를 썼다.
