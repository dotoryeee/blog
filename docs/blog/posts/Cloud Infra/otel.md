...
- 주의: Baggage는 신호 데이터가 아니라 신호에 덧붙는 전파용 컨텍스트
...
### 시맨틱 컨벤션
- 목적: http.request.method·db.system 같은 속성 키를 표준화해 백엔드 간 해석을 통일
...
- 수신 방식: Prometheus는 scrape(pull), OTLP 백엔드는 push로 데이터를 받음
