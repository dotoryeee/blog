...
| 용량 관리 | SystemMaxUse 기본 파일시스템 10%(상한 4GB), SystemKeepFree 15% |
...
### 참고
- systemd.service (freedesktop.org): https://www.freedesktop.org/software/systemd/man/latest/systemd.service.html
...
- systemd.timer (freedesktop.org): https://www.freedesktop.org/software/systemd/man/latest/systemd.timer.html
