...
| Nitro 기반 | 전용 Nitro 카드가 네트워크 전담, SR-IOV로 ENA 노출 | ena | 타입별 상이, GPU 인스턴스는 3,870Gbps까지 |
...
| 대역폭 | 인스턴스 타입별 상이. 네트워크 최적화는 c8gn 600Gbps(네트워크 카드 2장 합산), GPU 인스턴스는 P5 800Gbps·P6-B200 1,600Gbps·P6-B300 3,870Gbps |
